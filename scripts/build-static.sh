...
GOOS=linux GOARCH=amd64 go build -mod vendor \
    ...
    -ldflags "-extldflags '-static' -s -w -X github.com/cloudbase/garm-provider-oci/provider.Version=$VERSION" .
...
GOOS=windows GOARCH=amd64 CC=x86_64-w64-mingw32-cc go build -mod vendor \
    ...
    -tags osusergo,netgo,sqlite_omit_load_extension \
    -ldflags "-s -w -X github.com/cloudbase/garm-provider-oci/provider.Version=$VERSION" .
